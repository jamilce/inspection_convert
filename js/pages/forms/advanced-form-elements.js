$(function () {
    ...
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('059-999-9999', { placeholder: '05_-___-____' });
    //EID Number
    $demoMaskedInput.find('.EID-number').inputmask('784-9999-9999999-9', { placeholder: '784-____-_______-_' });
